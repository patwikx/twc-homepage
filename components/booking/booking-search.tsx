...
import type { UseBookingStateReturn } from "@/hooks/use-booking-state"
...
export function AvailabilitySearch({ booking, showBusinessUnitSelector = false, className }: AvailabilitySearchProps) {
